...
<head>
    ...
    <title>Prime Motocare & Detailing - Contact Page</title>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand me-lg-5 me-0" href="/">
                    <img src="images/logoprime.png" class="logo-image img-fluid" alt="primemotocare">
                </a>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12 pe-lg-5">
                        <div class="contact-info">
                            <h3 class="mb-4">Pengaduan Layanan</h3>

                            <p class="d-flex border-bottom pb-3 mb-4">
                                <strong class="d-inline me-4">Phone:</strong>
                                <span>+62 812-6775-0525</span>
                            </p>
                            ...
                            <p class="d-flex">
                                ...
                                <span>Jl. S. Parman No.130 D, Lolong Belanti, Kec. Padang Utara, Kota Padang, Sumatera Barat 25136</span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <ul class="social-icon">
                        <li class="social-icon-item">
                            <a href="https://www.instagram.com/primemotocare/?igsh=cndnNzYwZjFoNWp1" class="social-icon-link bi-instagram"></a>
                        </li>
