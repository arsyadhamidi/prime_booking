...
<head>
    ...
    <title>Prime Motocare & Detailing - About Page</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 text-center">
                        ...
                        <h2 class="mb-0">About Prime Motocare</h2>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="pb-5 mb-5">
                            <div class="section-title-wrap mb-4">
                                <h4 class="section-title">History Prime Motocare</h4>
                            </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="section-title-wrap mb-5">
                            <h4 class="section-title">Meet The Owner</h4>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="team-thumb bg-white shadow-lg">
                            <video class="about-video img-fluid" controls>
                                <source src="images/introprime.mp4" type="video/mp4">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="team-thumb bg-white shadow-lg">
                            <img src="images/primebirupage.jpeg"
                            ...
                            <div class="team-info">
                                ...
                                <span class="badge">Prime Post</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                        <div class="team-thumb bg-white shadow-lg">
                            <img src="images/primekuning1.jpeg"
                                class="about-image img-fluid" alt="">
