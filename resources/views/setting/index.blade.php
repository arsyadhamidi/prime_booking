                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-profile" aria-selected="false">Ubah Email</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                    ...
                                    <div class="row">
                                        <div class="col-lg">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="5" placeholder="Masukan alamat domisili">{{ old('alamat', $users->alamat ?? '-') }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="emaillama"
                                                    class="form-control @error('emaillama') is-invalid @enderror"
                                                    placeholder="Masukan nama lengkap"
                                                    value="{{ old('emaillama', $users->email ?? '-') }}" readonly>
                                                @error('emaillama')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="email"
                                                    ...
                                                    placeholder="Masukan nomor telepon" value="{{ old('email') }}">
                                                @error('email')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
